...
class CallTrackingService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        AppLogger.log(this, "SERVICE", "onStartCommand action=${intent?.action}")
        if (serviceStarted) {
            AppLogger.log(this, "SERVICE", "onStartCommand: service already started")
        }
        when (intent?.action) {
    ...
    override fun onCreate() {
        ...
        val notification = createNotification("Приложение активно")
        startForeground(SERVICE_NOTIFICATION_ID, notification)
        AppLogger.log(this, "SERVICE", "startForeground выполнен")

        if (serviceStarted) {
            AppLogger.log(this, "SERVICE", "onCreate: service already started, skip init")
            return
        }
        serviceStarted = true
        ...
        AppLogger.log(this, "SERVICE", "tracker.start() result=$trackerStarted")
    ...
    private fun startPeriodicCaptureFallback() {
        ...
        AppLogger.log(this, "SERVICE", "polling start")
    ...
    override fun onDestroy() {
        AppLogger.log(this, "SERVICE", "service destroyed")
