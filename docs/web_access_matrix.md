...
| B | `get_calls.php`, `dashboard.php`, `update_call.php`, чтение `admin_email.php` | `admin` — все данные; `manager` — только данные стабильного идентификатора своей учётной записи |
