...
foreach (['loadClientNamesForCalls', 'getCachedClientName', 'clientNamesByEmail', 'group.displayName', "formatPhoneForDisplay(call?.phone)||existing||'Без номера телефона'", 'fetchClientOutgoingEmails', 'Email отправлен', 'Отправлено email:', 'data-email-id', 'background:#fef3c7', 'border:1px solid #f59e0b'] as $required) {
